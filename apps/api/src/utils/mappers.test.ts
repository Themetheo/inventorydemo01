...
describe("Google Sheets row mappers", () => {
  it("maps item headers including Image_URL and boolean state", () => expect(mapItem({ Item_ID: " I1 ", Item_Name: " น้ำ ", Category_ID: " C1 ", Unit: " ขวด ", Image_URL: " /images/items/water.webp ", Description: " เย็น ", Is_Active: "FALSE", Created_At: " now " })).toEqual({ itemId: "I1", itemName: "น้ำ", categoryId: "C1", unit: "ขวด", imageUrl: "/images/items/water.webp", description: "เย็น", isActive: false, createdAt: "now" }));
